...
function OrderManagement() {
  ...
  const deleteAllOrders = async () => {
    if (!window.confirm("⚠️ WARNING: This will delete ALL orders permanently! Are you sure?")) {
      return;
    }
    
    if (!window.confirm("This action cannot be undone. Delete all orders?")) {
      return;
    }
                ...
                <tr key={order._id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-center">
                    <button
                      ...
                      className="bg-[#3b82f6] text-white px-3 py-1 rounded text-sm hover:bg-[#2563eb] mr-2"
                    >
                      View
                    </button>
                    {order.status !== "cancelled" && (
            ...
            <div className="mb-4">
              ...
              {selectedOrder.shippingAddress ? (
                <p className="text-sm">
                  ...
                  {selectedOrder.shippingAddress.city || ""}{selectedOrder.shippingAddress.city && selectedOrder.shippingAddress.state ? ", " : ""}{selectedOrder.shippingAddress.state || ""} {selectedOrder.shippingAddress.zipCode || ""}<br />
